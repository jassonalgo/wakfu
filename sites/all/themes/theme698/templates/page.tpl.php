  ...
  <div id="main-wrapper">
    ...
    <footer id="footer" role="contentinfo">
        <div class="footer-wrapper clearfix">
            ...
            <?php if ($is_front): ?>More Game Portal Drupal Themes at <a rel="nofollow" href="http://www.templatemonster.com/category/game-portal-drupal-themes/" target="_blank">TemplateMonster.com</a><?php endif; ?>
        </div><!-- /#footer-wrapper -->
    </footer><!-- /#footer -->
